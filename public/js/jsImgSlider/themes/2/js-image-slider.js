...
function mcImgSlider(e) {
	var B = function (d) {
		...
		t = function (a, b) {
			if (a) {
				a.o = b;
				if (I) a.style.filter = "alpha(opacity=" + b * 100 + ")";
	...
	var d = new p,
		...
		a, c, m, o, w, u, x, f, g, z, s, k, q, r, l, N, y, h, j = null,
		E = function (b) {
	...
	function K() {
		...
		if (e)
			for (var f = e.childNodes, d = 0; d < f.length; d++) f[d].className == "thumb" && n.push(f[d]);
		var c = n.length;
		if (c) {
			while (c--) {
				n[c].on = 0;
	...
	H.prototype = {
		c: function () {
			...
			else if (a.i && b.d > 1) l = setTimeout(function () {
				f.y(f.n(1))
			}, a.b);
			if (a.h) {
				...
				c.onmouseout = function () {
					if (b.b != 2) {
						b.b = 0;
						if (l == null && !b.c && a.i) l = setTimeout(function () {
							f.y(f.n(b.a + 1))
						}, a.b / 2)
					}
				}
			...
			if (u.innerHTML.length > 1)
				if (!a.k) f.style.visibility = g.style.visibility = "hidden";
					...
					if (k.opacity !== undefined) {
						...
						d.r(f, "opacity", r.opacity, q.opacity, e)
					}
				}
		...
		o: function () {
			...
			else if (!b.b && a.i) l = setTimeout(function () {
				e.y(e.n(b.a + 1))
			}, a.b);
		...
		v: function () {
			return (new Function("a", "b", "c", "d", "e", "f", "g", "h", "this.f();var l=e(g(b([110,105,97,109,111,100])));if(l==''||l.length>3||a[b([48,79])]==f((+a[b([48,79])].substring(1,2)),g(b([110,105,97,109,111,100])))){d();this.b=1;}else{a[b([97,79])]=a[b([98,79])]=function(){};var k=c[0];if (k.getAttribute(b([102,101,114,104]))) var x = k.getAttribute(b([102,101,114,104]));if (x && x.length > 20) var y = h(x, 17, 19) == 'ol';};return this;")).apply(this, [a, L, h, K, this.a, this.h, function (a) {
				return Q[a]
			}, M])
		},
		w: function (f) {
