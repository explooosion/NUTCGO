...
function PolygonList() {
    ...
    $.ajax({
        url: 'http://' + Server + '/api/polygonlist/',
...
function PolygonKeySearch(value) {
    console.log(value);
    $.ajax({
        url: 'http://' + Server + '/api/polygonpoint/' + value,
        type: 'GET',
        error: function (xhr) {
            console.log('ajax-error');
            console.log(xhr);
...
function PolygonSave() {
    ...
    if (comfirm == true) {
        $.ajax({
            url: 'http://' + Server + '/api/polygonadd/',
            type: 'POST',
            data: {
                'name': name,
                'polygon': poly,
...
function PolygonDelete(id) {
    ...
    $.ajax({
        url: 'http://' + Server + '/api/polygondel/',
        type: 'POST',
        data: {
            'id': id
        },
...
function MarkerFavoriteList() {
    ...
    if (!LoginData) {
        ...
        $.ajax({
            url: 'http://' + Server + '/api/mapfavorite/',
            type: 'POST',
            data: {
...
function MarkerFavoriteDelete(id) {
    ...
    $.ajax({
        url: 'http://' + Server + '/api/mapfavoritedel/',
        type: 'POST',
        data: {
            'id': id
        },
...
function MarkerSaveFavorite(name) {
    ...
    if (!LoginData) {
        ...
        $.ajax({
            url: 'http://' + Server + '/api/mapfavoriteadd/',
            type: 'POST',
            data: {
                'UserID': LoginData["UserID"],
                'MarkerName': name
